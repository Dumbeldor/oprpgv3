...
class Forum extends MY_Controller {
	...
	public function index() {
		...
		$data['title'] = 'Forum';
	    $data['types'] = $this->forum_model->get_types();
	...
	public function categories($id_type) {
		...
		$data['title'] = 'Forum';
	    $data['categories'] = $this->forum_model->get_categories($id_type);
	...
	public function topics($id_cate) {
		...
		$data['topics'] = $this->forum_model->get_topics($id_cate);
	...
	public function send_topic() {
		...
		$this->send_message($message,$date_message,$id_topic[0]['topic_id'],
