...
CREATE TABLE forums_categories(
        ...
        cate_block Bool NOT NULL ,
        cate_types Varchar (25) ,
        PRIMARY KEY (cate_id )
)ENGINE=InnoDB;
...
CREATE TABLE tchats_messages(
        ...
        user_id       Int NOT NULL ,
        PRIMARY KEY (message_id ,tchat_id ,user_id )
)ENGINE=InnoDB;
...
CREATE TABLE forums_topics_types(
        types_id   int (11) Auto_increment  NOT NULL ,
        types_name Varchar (25) NOT NULL ,
...
CREATE TABLE kick(
        kick_id    int (11) Auto_increment  NOT NULL ,
        kick_cause Varchar (25) NOT NULL ,
        kick_time  TimeStamp NOT NULL ,
        kick_zone  Varchar (25) NOT NULL ,
        user_id    Int NOT NULL ,
        PRIMARY KEY (kick_id ,user_id )
)ENGINE=InnoDB;
...
CREATE TABLE users_ranks(
        userr_id    int (11) Auto_increment  NOT NULL ,
        userr_name  Varchar (25) NOT NULL ,
        userr_block Bool NOT NULL ,
...
ALTER TABLE users ADD CONSTRAINT FK_users_userr_id FOREIGN KEY (userr_id) REFERENCES users_ranks(userr_id);
...
ALTER TABLE forums_topics ADD CONSTRAINT FK_forums_topics_types_id FOREIGN KEY (types_id) REFERENCES forums_topics_types(types_id);
...
ALTER TABLE kick ADD CONSTRAINT FK_kick_user_id FOREIGN KEY (user_id) REFERENCES users(user_id);
...
ALTER TABLE chests_objects ADD CONSTRAINT FK_chests_objects_chest_id FOREIGN KEY (chest_id) REFERENCES chests(chest_id);
ALTER TABLE chests_objects ADD CONSTRAINT FK_chests_objects_obj_id FOREIGN KEY (obj_id) REFERENCES objects(obj_id);
