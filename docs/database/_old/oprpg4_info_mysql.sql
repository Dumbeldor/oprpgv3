...
CREATE TABLE equipages_membres(
        ...
        PRIMARY KEY (crew_id ,user_id ,equig_id )
)ENGINE=InnoDB;
...
ALTER TABLE cages_comptes ADD CONSTRAINT FK_cages_comptes_user_id FOREIGN KEY (user_id) REFERENCES users(user_id);
...
ALTER TABLE equipages_membres ADD CONSTRAINT FK_equipages_membres_crew_id FOREIGN KEY (crew_id) REFERENCES crews(crew_id);
ALTER TABLE equipages_membres ADD CONSTRAINT FK_equipages_membres_user_id FOREIGN KEY (user_id) REFERENCES users(user_id);
