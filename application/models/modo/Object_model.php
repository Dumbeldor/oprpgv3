...
class Object_model extends CI_Model
{
    ...
    public function addObject($name, $description, $price, $attack, $speed, $defense, $attackMag, $addLife, $addEnergy, $rarity, $type){
        $this->db->insert('objects', array('name' => $name, 'description' => $description,
                                            'price' => $price, 'attack' => $attack,
                                            'speed' => $speed, 'defense' => $defense,
                                            'attackMag' => $attackMag, 'addLife' => $addLife, 'addEnergy' => $addEnergy,
                                            'rarity' => $rarity, 'id_objects_types' => $type));
    }

    public function modifyObject($id, $name, $description, $price, $attack, $speed, $defense, $attackMag, $addLife, $addEnergy, $rarity, $type, $is_block) {
        $this->db->where('id', $id)
        ->update('objects', array('name' => $name, 'description' => $description,
            'price' => $price, 'attack' => $attack,
            'speed' => $speed, 'defense' => $defense,
            'attackMag' => $attackMag,
            'addLife' => $addLife, 'addEnergy' => $addEnergy,
