...
class Crews extends MY_Controller {
  ...
  public function candidacy($id=0) {
    ...
    if($id == 0 
      || $this->crew->inCrew() 
      || $this->crews_model->pendingRequest($id)) {
      redirect(base_url('/crews/index'));
    }
...
} //-- end class Crews extends MY_Controller